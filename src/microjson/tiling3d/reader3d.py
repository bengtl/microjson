"""TileReader3D — decode .mjb files back to features.
...
def decode_tile(data: bytes) -> list[dict]:
    """Decode a .mjb tile from protobuf bytes.
...
class TileReader3D:
    ...
    def read_tile(
        ...
        """
        tile_path = self._base_dir / str(z) / str(x) / str(y) / f"{d}.mjb"
