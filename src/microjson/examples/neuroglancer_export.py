"""Example: Export MicroJSON neuron morphologies to Neuroglancer precomputed format.
...
Run:
    python -m microjson.examples.neuroglancer_export [--output-dir OUTPUT_DIR]
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export MicroJSON to Neuroglancer precomputed format"
    )
    parser.add_argument(
        "--output-dir",
    ...
    print(f"  1. python -m microjson.examples.neuroglancer_serve {output_dir}")
