...
Converts MicroJSON feature properties into the Neuroglancer
...
from ..model import MicroFeature
from .models import (
...
def features_to_segment_properties(
    features: Sequence[MicroFeature],
    segment_ids: Sequence[int],
) -> dict[str, Any]:
    """Build segment_properties inline dict from MicroJSON features.
    ...
    Args:
        features: MicroJSON features with properties dicts.
