"""Tests for scripts/obj_to_microjson.py — OBJ → MicroJSON conversion."""
...
class TestObjToFeature:
    def test_basic(self):
        """OBJ → MicroFeature with TIN geometry and basic properties."""
        obj = _write_obj(
            "v 0 0 0\nv 1 0 0\nv 0 1 0\nv 1 1 0\n"
            "f 1 2 3\nf 2 4 3\n"
        )
...
class TestBuildCollection:
    ...
    def test_serialization_roundtrip(self):
        ...
        parsed = MicroFeatureCollection.model_validate_json(json_str)
